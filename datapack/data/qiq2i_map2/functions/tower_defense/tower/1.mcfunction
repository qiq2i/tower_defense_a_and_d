...
execute if score @s qiq2i_map2.tower.sl matches 20.. at @s positioned ~ ~2 ~ unless entity @e[distance=..1,limit=1,type=block_display,nbt={block_state:{Name:"minecraft:tnt"}},tag=qiq2i_map2.block_display.1] run function qiq2i_map2:function/block_display/input_block {block:"minecraft:tnt"}
