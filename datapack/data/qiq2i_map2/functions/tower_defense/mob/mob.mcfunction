...
execute if block ~ ~-2 ~ minecraft:magenta_glazed_terracotta[facing=east] run scoreboard players set @s qiq2i_tower.mob.fx 3
execute if block ~ ~-2 ~ minecraft:magenta_glazed_terracotta[facing=north] run scoreboard players set @s qiq2i_tower.mob.fx 4
