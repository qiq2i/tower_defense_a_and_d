...
$execute store result storage qiq2i_map2 marker.1 long 0.05 run scoreboard players get @e[type=marker,limit=1,tag=qiq2i_map2.player.$(home_Owner_id)] qiq2i_map2.money 
