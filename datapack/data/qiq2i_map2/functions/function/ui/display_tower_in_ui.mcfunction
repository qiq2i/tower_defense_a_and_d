...
$execute on vehicle on passengers if entity @s[type=text_display,tag=qiq2i_map2.ui.text] run data modify entity @s text set value '[{"nbt":"tower[{id:$(ui_id)}].name","storage":"qiq2i_map2","color":"yellow"},{"text":"\\n§f伤害："},{"nbt":"tower[{id:$(ui_id)}].damage","storage":"qiq2i_map2","color":"yellow"},{"text":"\\n§f攻速："},{"nbt":"tower[{id:$(ui_id)}].speed","storage":"qiq2i_map2","color":"yellow"},{"text":"次/秒\\n§f攻击范围："},{"nbt":"tower[{id:$(ui_id)}].range","storage":"qiq2i_map2","color":"yellow"}]'