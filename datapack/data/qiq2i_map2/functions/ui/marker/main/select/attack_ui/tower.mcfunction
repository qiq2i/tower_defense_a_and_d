...
$execute if data storage qiq2i_map2 temp_ui_select{page:"tower_build"} run function qiq2i_map2:function/tower_build/input_uuid {uuid:$(uuid),tower_id:"$(ui_id)",x:$(facing_pos_x),y:$(facing_pos_y),z:$(facing_pos_z)}
